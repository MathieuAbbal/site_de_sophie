    ...
    <section id="contact" class="py-20 bg-white">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
          <h2 class="text-3xl md:text-4xl font-bold text-gray-800">Contact & Localisation</h2>
          ...
          <div class="space-y-8">
            <div class="flex items-start space-x-4">
              ...
              <div>
                ...
                <p class="text-gray-600">02 rue Can Partere<br>66100 Perpignan</p>
              </div>
            </div>
            ...
            <div class="flex items-start space-x-4">
              ...
              <div>
                ...
                <a href="tel:+33626038524" class="text-teal-600 hover:text-teal-700 text-lg font-medium transition">06 26 03 85 24</a>
              </div>
            </div>
            ...
            <div class="flex items-start space-x-4">
              ...
              <div>
                ...
                <a href="mailto:sophiecama@hotmail.com" class="text-teal-600 hover:text-teal-700 transition">sophiecama&#64;hotmail.com</a>
              </div>
            </div>
            ...
            <div class="flex items-start space-x-4">
              ...
              <div>
                ...
                <p class="text-gray-600">7j/7 : 08h00 - 20h00</p>
              </div>
            </div>
          </div>
