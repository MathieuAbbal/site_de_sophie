...
export class FaqComponent {
  ...
  faqs = [
    ...
    { question: 'Quelle est votre zone d\'intervention ?', answer: 'Notre cabinet intervient principalement dans les quartiers du Moulin à Vent et de Catalunya à Perpignan. N\'hésitez pas à nous contacter pour vérifier si votre domicile se situe dans notre zone d\'intervention.' },
    ...
    { question: 'Comment prendre rendez-vous ?', answer: 'Vous pouvez nous joindre par téléphone au <a href="tel:+33626038524" class="text-teal-600 hover:underline">06 26 03 85 24</a> ou par email à <a href="mailto:sophiecama@hotmail.com" class="text-teal-600 hover:underline">sophiecama&#64;hotmail.com</a>. Nous vous rappellerons dans les plus brefs délais.' },
